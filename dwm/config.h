...
static const char col_cyan[]        = "#e23d5e";
...
static Key keys[] = {
	...
	{ 0,			XF86XK_AudioLowerVolume, spawn,		SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -500; pkill -RTMIN+1 dwmblocks") },
	{ 0, 			XF86XK_AudioRaiseVolume, spawn, 	SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +500; pkill -RTMIN+1 dwmblocks") },
